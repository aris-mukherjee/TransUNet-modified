...
def inference(args, model, test_save_path=None):
    ...
    for sub_num in range(num_test_subjects):
        ...
        metric_i = test_single_volume(image, label, model, classes=args.num_classes, dataset = 'BIDMC', optim = 'ADAM', model_type = 'TU_1HEAD', seed= '1234', patch_size=[args.img_size, args.img_size],
...
if __name__ == "__main__":
    ...
    snapshot = os.path.join('/scratch_net/biwidl217_second/arismu/Master_Thesis_Codes/project_TransUNet/model/2022/', 'TU_1HEAD_best_val_loss_seed1234.pth')
    ...
    if args.is_savenii:
        ...
        test_save_path = os.path.join(args.test_save_dir, 'BIDMC_TU_1HEAD_test_seed1234')
