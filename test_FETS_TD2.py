...
parser.add_argument('--test_dataset', type=str,
                    default='FETS_TEST_TD2', help='experiment_name')
...
def inference(args, model, test_save_path=None):
 ...
 """
        ...
        metric_whole, metric_enhancing, metric_core, pred_l, label_l = test_single_volume_FETS(image, label, model, classes=args.num_classes, dataset = 'FETS_TD2', optim = 'ADAM', model_type = f'{model_type}', seed = '{seed}', patch_size=[args.img_size, args.img_size],
    ...
    #plt.show()
    #plt.savefig(f'/scratch_net/biwidl217_second/arismu/Data_MT/plots/UNET_FETS_TD2.png')
