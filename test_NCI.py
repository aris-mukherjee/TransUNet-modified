...
def inference(args, model, test_save_path=None):
    ...
    for sub_num in range(num_test_subjects):
        ...
        metric_i = test_single_volume(image, label, model, classes=args.num_classes, dataset = 'NCI', optim = 'ADAM', model_type = 'TU_NO_MLP', seed = '100', patch_size=[args.img_size, args.img_size],
...
if __name__ == "__main__":
    ...
    if args.is_savenii:
        ...
        test_save_path = os.path.join(args.test_save_dir, 'NCI_TU_NO_MLP_test_seed100')
