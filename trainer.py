...
def trainer_runmc(args, model, snapshot_path):
    ...
    writer = SummaryWriter('/scratch_net/biwidl217_second/arismu/Tensorboard/2022/' + 'TU_NO_QKV_AND_1HEAD_log_400epochs_seed100') 
    iter_num = 0
    ...
    # ============================  
            ...
            if (iter_num+1) % 85 == 0:
                ...
                if val_loss < best_val_loss:
                    save_mode_path = os.path.join('/scratch_net/biwidl217_second/arismu/Master_Thesis_Codes/project_TransUNet/model/2022/', 'TU_NO_QKV_AND_1HEAD_best_val_loss_seed100' + '.pth')
    ...
    # ============================  
        ...
        if epoch_num > int(max_epoch / 4) and (epoch_num + 1) % save_interval == 0:
            save_mode_path = os.path.join('/scratch_net/biwidl217_second/arismu/Master_Thesis_Codes/project_TransUNet/model/2022/', 'TU_NO_QKV_AND_1HEAD_best_val_loss_seed100' + 'epoch_' + str(epoch_num) + '.pth')
            torch.save(model.state_dict(), save_mode_path)
