...
def inference(args, model, test_save_path=None):
    ...
    imvl = loaded_test_data[9]   #shape (194, 256, 256)
    gtvl = loaded_test_data[10]
    ...
    orig_data_siz_z = loaded_test_data[11]
    num_test_subjects = loaded_test_data[12]
    ...
    for sub_num in range(num_test_subjects):
        ...
        image = imvl[:,:, subject_id_start_slice:subject_id_end_slice] 
        label = gtvl[:,:, subject_id_start_slice:subject_id_end_slice] 
...
if __name__ == "__main__":
    ...
    if args.is_savenii:
        args.test_save_dir = '../predictions_on_validation_set'
        test_save_path = os.path.join(args.test_save_dir, 'Validation_set_RUNMC_UNET_ADAM')
