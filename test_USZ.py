...
def inference(args, model, test_save_path=None):
    ...
    for sub_num in [1, 2, 4, 8, 10, 11, 12, 14, 18, 19]:
        ...
        metric_i, pred_l, label_l = test_single_volume(image, label, model, classes=args.num_classes, dataset = 'USZ', optim = 'ADAM', model_type = 'UNWT', seed = '1234', patch_size=[args.img_size, args.img_size],
...
if __name__ == "__main__":
    ...
    if args.is_savenii:
        ...
        test_save_path = os.path.join(args.test_save_dir, 'USZ_UNWT_test_seed1234')
