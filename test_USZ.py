...
def inference(args, model, test_save_path=None):
    ...
    for sub_num in [1, 2, 4, 8, 10, 11, 12, 14, 18, 19]:
        ...
        metric_i = test_single_volume(image, label, model, classes=args.num_classes, dataset = 'USZ', optim = 'ADAM', model_type = 'SIZETEST_TU_NO_ATTN', seed = '100', patch_size=[args.img_size, args.img_size],
...
if __name__ == "__main__":
    ...
    if args.is_savenii:
        ...
        test_save_path = os.path.join(args.test_save_dir, 'SIZETEST_USZ_TU_NO_ATTN_test_seed100')
