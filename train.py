...
parser.add_argument('--max_iterations', type=int,
                    default=5101, help='maximum epoch number to train')
...
if __name__ == "__main__":
    ...
    snapshot_path = snapshot_path+'_'+str(args.max_iterations)[0:2]+'k' if args.max_iterations != 5101 else snapshot_path
